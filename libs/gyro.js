...
"use strict";
  ...
  var _GyroscopeUpdatedEvent = class extends import_core.TypedEvent {
  ...
  GyroscopeUpdatedEvent.type = "gyroscope-updated";
  ...
  var GyroscopePlugin = class extends import_core3.AbstractConfigurablePlugin {
    ...
    start(moveMode = this.config.moveMode) {
      return this.state.isSupported.then((supported) => {
        ...
        if (!this.controls) {
          this.controls = new DeviceOrientationControls(new import_three2.Object3D());
        } else {
